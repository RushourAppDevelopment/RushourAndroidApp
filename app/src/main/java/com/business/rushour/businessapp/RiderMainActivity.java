...
public class RiderMainActivity extends AppCompatActivity
    ...
    public void postride()
    {
        ...
        alertDialog.setTitle("Post Ride");


        // Setting Dialog Message
        alertDialog.setMessage("To Post Ride, you should be authenticated with your Driving License and Vehicle RC Information.");

        // Setting Icon to Dialog
        //alertDialog.setIcon(R.drawable.delete);

        // Setting Positive "Yes" Button
        alertDialog.setPositiveButton("Authenticate", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog,int which) {

                Intent aboutus = new Intent(getApplicationContext(), RiderRegistrationAsOwnerActivity.class);
                startActivity(aboutus);
            }
        });
